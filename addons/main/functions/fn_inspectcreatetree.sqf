...
[ZEN_FAVORITES_LOG_LEVEL_INFO, "inspecting Zeus Create tree"] call zen_favorites_main_fnc_log;
...
if (isNull _tree) exitWith {
    [ZEN_FAVORITES_LOG_LEVEL_WARN, "no active Create tree found"] call zen_favorites_main_fnc_log;
};
...
if (_selectedPath isEqualTo []) exitWith {
    [ZEN_FAVORITES_LOG_LEVEL_INFO, "active tree has no selected row"] call zen_favorites_main_fnc_log;
};
