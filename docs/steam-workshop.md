...
When selecting Empty Units favorites from the generated Favorites category, ZEN Filter uses the ZEN Placement component (`zen_placement`) to show the advanced object placement preview.
